...
export const ParkingStatusCard = () => {
  ...
  useEffect(() => {
    ...
    const entryDate = new Date(activeParking.entryTime).getTime();
  ...
  }, [activeParking.isParking, activeParking.entryTime]);
    ...
    <View style={styles.container}>
      <View style={styles.topSection}>
        <View style={styles.infoLeft}>
          <Text style={styles.label}>Masuk: {formattedEntryTime}</Text>
          <Text style={styles.duration}>{liveDuration}</Text>
        </View>
        <View style={styles.infoRight}>
          <Text style={styles.label}>Estimasi Biaya</Text>
          <Text style={styles.fee}>~{formatCurrency(activeParking.fee)}</Text>
        </View>
      </View>
      ...
      <View style={styles.actionSection}>
        ...
        >
          <Text style={styles.secondaryButtonText}>Lihat QR</Text>
        </TouchableOpacity>
