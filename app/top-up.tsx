...
const PAYMENT_METHODS = [
  { id: 'transfer', name: 'Bank Transfer', icon: <Landmark color={Colors.primary} size={24} /> },
  { id: 'qris', name: 'QRIS', icon: <QrCode color={Colors.primary} size={24} /> },
  { id: 'ewallet', name: 'E-Wallet', icon: <Smartphone color={Colors.primary} size={24} /> },
];
